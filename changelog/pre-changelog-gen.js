...
exports.preTagGeneration = async function (tag) {
  ...
  try {
	...
	{
		schema=$(cat /home/runner/work/openapi-to-hurl/openapi-to-hurl/test_files/pet_store_advanced.json)
	...
	{
		hyperfine --warmup 50 '/home/runner/work/openapi-to-hurl/openapi-to-hurl/target/release/openapi-to-hurl /home/runner/work/openapi-to-hurl/openapi-to-hurl/test_files/pet_store_advanced.json -o /' -u millisecond --shell=none &&
		git log --format="%H" -n 1 &&
		echo ${tag};
